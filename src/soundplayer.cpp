...
SoundPlayer::~SoundPlayer() { Mix_Quit(); }
...
void SoundPlayer::HaltBackgroundMusic() { _backgroundSong.HaltSong(); }
...
void SoundPlayer::HaltGameOverMusic() { _gameOverSong.HaltSong(); }

void SoundPlayer::PlayEatingChunk() { _eatingChunk.PlayChunk(); }
void SoundPlayer::PlayCollisionChunk() { _collisionChunk.PlayChunk(); }
...
SoundPlayer::Song::~Song() { HaltSong(); }
...
void SoundPlayer::Song::HaltSong() { Mix_HaltMusic(); }

void SoundPlayer::Song::PauseSong() { Mix_PauseMusic(); }
